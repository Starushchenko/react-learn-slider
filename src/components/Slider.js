...
class Slider extends React.Component {
	...
	renderSlides() {
		...
		return this.state.slides.map((item, index) => (
				<div className="eachSlide" key={index} style={{backgroundImage: item.eachSlide, width: transition}}>
	...
	render() {
		return (
				<div className="slider">
					...
					<button className="toggle-play" onClick={this.toggleAutoPlay}>{this.renderPlayStop()}</button>
				</div>
		)
	}
}
